  ...
  return (
    <div id='aboutus' className='px-5 py-10 flex flex-col sm:flex sm:flex-row sm:items-center'>
     ...
     <p className='flex flex-col gap-5 text-zinc-600 mt-3 font-normal'>
          <span className='text-lg font-light'>Are you trying to find a professional who can fix your LED TV the best way possible? If so, you've found the proper site in Pune.</span>

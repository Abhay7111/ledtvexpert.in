  ...
  return (
    <div className='w-full bg-zinc-800 text-zinc-500 pt-16'>
      ...
      <div className=' px-5 flex sm:w-1/3 flex-col'>
        ...
        <p className='flex gap-3 font-light flex-wrap'><span><a href="tel:+917219237200"><i class="ri-phone-line text-red-500"> </i>+91-7219237200</a></span><span><a href="mailto:vishwaxupte@gmail.com"><i class="ri-mail-line text-red-500"> </i>vishwaxupte@gmail.com</a></span>
      ...
      <div className='flex px-5 sm:w-1/3 flex-col'>
        ...
        <ul className='w-full py-5'>
          ...
          <a href="tel:+917219237200"><li className='py-2 mt-8 px-2 border-zinc-600 hover:bg-green-400 hover:text-zinc-800'>Call Us on +91-7219237200</li></a>
        </ul>
      </div>
      </span>

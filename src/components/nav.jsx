...
function Nav() {
  ...
  return (
    <div className=' w-full min-h-36 pt-6 bg_nav flex flex-col items-center justify-center text-zinc-800 sm:z-50 sm:flex-row sm:px-5 sm:gap-10 sm:min-h-20'>
     ...
     <span>
     <a href="tel:+917219237200" className='flex flex-col'> <span className='flex items-center'><span className="material-symbols-outlined ">call</span><span className='sm:text-sm'>+91-7219237200</span></span> <span className=''>Call us for more details</span></a>
     </span>
     </span>

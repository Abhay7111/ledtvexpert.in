...
function Whyus() {
  return (
    ...
    <div className="w-full h-auto bg-white py-20 flex flex-col gap-6 items-center text-zinc-100 sm:flex sm:flex-row sm:flex-wrap sm:items-center sm:justify-center">
